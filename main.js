...
$nextButton.onclick = (e) =>{
    ...
    const numberOfFamilyMembers = Number(document.querySelector('#family-members').value)
...
$calculateButtton.onclick = ()=>{
    ...
    $average.textContent= `El promedio de edad del grupo familiar es : ${getAverage(agesArray)}`;
